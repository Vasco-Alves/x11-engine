...
public:
    ...
    // Calculates the full Model Matrix: Translation * Rotation * Scale. From local coords to world coords.
...
public:
    ...
    void Update(Input &input) override {
        // // Rotate 1 degree per frame (much more intuitive than radians)
        // rotation.y += 1.0f;
        // rotation.x += 0.5f;

        // // Keep rotation within 0-360 for cleanliness (optional)
        ...
        // // Scale controls (Example: + / - keys)
        // if (input.IsKeyDown(XK_plus))
        //     scale += {0.1f, 0.1f, 0.1f};

        // if (input.IsKeyDown(XK_minus))
        //     scale -= {0.1f, 0.1f, 0.1f};
    }
